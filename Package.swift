    ...
    targets: [
        .target(
            ...
            exclude: [
                ...
                "Features/Claude/ComprehensionCoachView.swift",
                "Features/Claude/PronunciationTutorView.swift",
                "Features/Claude/GrammarExplainerView.swift",
                "Features/Claude/ContentAdapterView.swift",
                "Features/Claude/CulturalContextView.swift",
                "Features/Onboarding",
                "Features/MediaLibrary",
                "Features/MediaLesson",
                "Features/Pronunciation",
                "Features/Review/FlashcardView.swift",
                "Features/Review/ReviewSessionView.swift",
                "Features/Review/ReviewStatsView.swift",
                "Features/Progress",
                "Features/DailyPlan",
                "Features/Settings",
            ]
